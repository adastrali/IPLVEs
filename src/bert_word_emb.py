...
#         if ids+1 < len(contexts):
#             if words_order[ids+1] != word_current:
#                 target_word_average_embeddings, subword_average_embedding = process_word(
#                     word_current, subword_average_embedding, target_word_average_embeddings, args)
#                 word_current = words_order[ids+1]
#                 words_in_sentences.append(word_current)
#         else:
#             target_word_average_embeddings, subword_average_embedding = process_word(
